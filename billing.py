...
class Bill_App:
    def __init__(self, root):
        ...
        self.root.title("Eric Aleks Billing")
        bg_color = "yellow"
        title = Label(self.root, text="Eric Aleks Billing", font=('times new roman', 30, 'bold'), pady=2, bd=12, bg=bg_color, fg="Black", relief=GROOVE)
        title.pack(fill=X)
    # ================variables=======================
    ...
    # =============customer retail details======================
        ...
        c_bill_lbl = Label(F1, text="Bill Number:", bg="yellow", font=('times new roman', 15, 'bold'))
    ...
    # =================BillArea======================
        ...
        bill_title = Label(F5, text="Bill Area", font='arial 15 bold', bg="black", fg='white', bd=7, relief=GROOVE)
...
#==============welcome-bill==============================
    def welcome_bill(self):
        ...
        self.txtarea.insert(END, "\tWelcome Eric Aleks Retail")
